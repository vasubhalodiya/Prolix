    ...
    <div className="payment-success">
      ...
      <div className="payment-success-container">
        ...
        <div className="payment-success-title">
          ...
          <p className='payment-success-paragraph'>Your account is now upgraded with full access to movies, series & more.Enjoy seamless, ad-free streaming starting now. 🍿</p>
        </div>
